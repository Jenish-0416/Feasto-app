...
import { Bike, Clock, FileText } from "lucide-react";

export default function OrderHero() {
  return (
    <>
      {/* ✅ Desktop & Tablet Version (Hidden on Mobile) */}
      <div className="hidden md:block relative bg-[url('/public/assests/secheader.svg')] rounded-2xl py-8 md:py-12 lg:py-[60px] px-4 md:px-8 lg:px-[100px]">
      ...
      <div className=" mb-5 block md:hidden bg-[url('public/assests/orderbg.svg')] rounded-2xl shadow-lg  ">
        ...
        <div className="relative w-full p-10 flex flex-col justify-center items-center overflow-hidden">
          <img
            src="/public/assests/orderhero.svg"
            alt="Tandoori Pizza"
            className="w-[250px] h-40 object-cover rounded-lg"
          />
          <div className="absolute top-33 left-3 bg-white rounded-xl px-2 py-1 shadow text-center w-16">
            <p className="text-sm font-bold">3.4</p>
            <p className="text-yellow-500 text-xs leading-none">★★★★☆</p>
            <p className="text-[10px] text-gray-500">1,360 reviews</p>
          </div>
        </div>
        {/* Open Time */}
        ...
        <div className="text-center">
          ...
          <h2 className="text-[28px] font-extrabold text-[#03081F] mt-1">
            Tandoori Pizza London
          </h2>
        </div>
