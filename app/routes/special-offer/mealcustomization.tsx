...
const MealCustomization = () => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-60 z-50 flex justify-center items-center p-6">
      <div className="bg-white w-[600px] h-[760px] rounded-xl overflow-hidden relative shadow-lg flex flex-col">
        {/* Top Image */}
        ...
        <div className="flex flex-col h-full px-8 py-6">
          ...
          {/* Title */}
          <h2 className="text-[16px] font-mono mb-2">Customise your chicken Pizza</h2>
